...
class RequireIncludePlugin {
    ...
    apply(compiler) {
        compiler.plugin("compilation", (compilation, params) => {
            ...
            compilation.dependencyFactories.set(RequireIncludePlugin, normalModuleFactory);
            ...
            params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
                ...
                parser.plugin("typeof require.include", ParserHelpers.toContantDependency(JSON.stringify("function")));
            });
        });
    }
}
