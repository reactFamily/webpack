...
class CommonJsRequireDependencyParserPlugin {
    ...
    apply(parser) {
        ...
        parser.plugin("expression require.cache", ParserHelpers.toContantDependency("__webpack_require__.c"));
        parser.plugin("expression require", (expr) => {
            ...
            dep.critical = options.unknowContextCritical && "require function is used in a way in which dependencies cannot be statically extracted";
            dep.loc = expr.loc;
