...
class Chunk {
    ...
    addModule(module) {
        return thi.addToCollection(this.modules, module);
    }
    ...
    removeChunk(chunk) {
        const idx = this.chunks.indexOf(module);
        if (idx >= 0) {
    ...
    remove(reason) {
        ...
        this.parents.forEach(parentChunk => {
            // remove this chunk from this parents
            ...
            this.chunks.forEach(chunk => {
                /**
                 * remove this chunks as "intermediary" and connect
    ...
    integrate(otherChunk, reason) {
        ...
        otherChunk.modules.forEach(module => otherChunk.moveModule(module, this));
        otherChunk.module.length = 0;
    ...
    getChunkMaps(includeEntries, realHash) {
        ...
        (function addChunk(chunk) {
            ...
            if (!chunk.hashRuntime() || includeEntries) {
